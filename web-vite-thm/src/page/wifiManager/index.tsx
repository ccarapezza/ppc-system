                        ...
                        <div className="w-full h-full flex items-center transition-transform duration-500"
                          ...
                          <div id="page-1" className="w-full shrink-0 flex flex-col justify-center items-center gap-4">
                            <div class="font-bold text-center text-sm">
                              ...
                              Gracias por elegir nuestro  <span className={"font-bold"}>Sensor THM</span>, diseñado para monitorear temperatura, humedad y VPD en tus cultivos.
                            </div>
                            <Button
                              label="Siguiente"
                              icon="arrow-right"
                          ...
                          <div id="page-2" className="w-full shrink-0 flex flex-col justify-center items-center">
                            <div class="font-bold text-center text-sm flex flex-col justify-center items-center gap-1">
                              <div>
                                ...
                                Si quieres operar el sensor a traves de INTERNET, por favor conecta tu dispositivo a una red WiFi.
                              </div>
                              <Button
                            ...
                            <div class="font-bold text-center text-sm flex flex-col justify-center items-center gap-1">
                              <div>
                                <FontAwesomeIcon icon="temperature-half" className="text-violet-400 inline-flex items-baseline w-5 h-5 mx-2" />
                                Si no tienes una red WiFi (o simplemente no quieres usarla), puedes ver el sensor directamente.
                              </div>
                              <Button
                                label="Ir al sensor"
                                icon="arrow-right"
                    ...
                    {connectionStatus?.status == ConnectionState.CONNECTED &&
                        <div class="flex flex-col gap-4 items-center">
                          ...
                          <div class="font-bold text-center">
                            {isHome?
                              <>
                                <span className="text-sm flex gap-2 items-center">Redirigiendo al sensor en 5 segundos <FontAwesomeIcon icon="rotate" className={`text-black m-2 text-2xl animate-spin`} /></span>
                                
                              </>
                            :
                              "Ya puedes ver el sensor"
                            }
                          </div>
                          <Button
                            label="Ir al sensor"
